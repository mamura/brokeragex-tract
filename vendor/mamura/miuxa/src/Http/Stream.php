...
final class Stream implements StreamInterface
{
    ...
    {
        if (!$this->writable) {
            throw new RuntimeException('Cannor write to a non-writable stream.');
        }
    ...
    {
        if (!$this->readable) {
            throw new RuntimeException('Cannot read fron non-readable stream.');
        }
